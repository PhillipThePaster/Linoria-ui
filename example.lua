...
local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/PhillipThePaster/Linoria-ui/main/ui.lua'))()
Library:SetWatermark("$$$瞄准机器人aimbot$$$")
Library:Notify('Press Insert/Delete To Toggle The UI')
...
local Window = Library:CreateWindow("$$$瞄准机器人aimbot$$$")
...
do
    ...
    fov_circle.Color = Color3.fromRGB(135, 93, 255)
    ...
    Main:AddToggle("Visible", {Text = "Visible"}):AddColorPicker("Color", {Default = Color3.fromRGB(135, 93, 255)}):OnChanged(function()
    ...
    Main:AddToggle("MousePosition", {Text = "Show Fake Mouse Position"}):AddColorPicker("MouseVisualizeColor", {Default = Color3.fromRGB(135, 93, 255)}):OnChanged(function()
...
local GeneralTab = Window:AddTab("visual$$$")
local MainBOX = GeneralTab:AddLeftTabbox("Main")
do
    local Main = MainBOX:AddTab("not a thing here fag")
    end
